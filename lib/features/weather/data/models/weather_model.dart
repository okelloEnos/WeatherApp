...
class WeatherModel extends WeatherEntity{
  ...
  const WeatherModel({int? dateTime, List<Weather>? listOfWeather, Main? main, int? visibility, Wind? wind, Cloud? cloud, Rain? rain}) :
...
class WeatherM extends Weather{
  const WeatherM({int? id, String? main, String? description, String? icon}) : super(id: id, main: main, description: description, icon: icon);
...
class MainM extends Main{
  const MainM({double? temp, double? feelsLike, double? tempMin, double? tempMax, int? pressure, int? humidity}) : super(temp: temp, feelsLike: feelsLike, tempMin: tempMin, tempMax: tempMax, pressure: pressure, humidity: humidity);
...
class WindM extends Wind{
  const WindM({double? speed, int? deg}) : super(speed: speed, deg: deg);
...
class CloudM extends Cloud{
  const CloudM({int? all}) : super(all: all);
...
class RainM extends Rain{
  const RainM({double? oneHour, double? threeHours}) : super(oneHour: oneHour, threeHours: threeHours);
